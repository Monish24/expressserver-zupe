...
export function ulib() {
  ...
  app.post('/lib/libsongssend', (req, res) => {
    getSongsFromLib("3e164cd7-df60-4e17-a90f-a7c87c06e7ae")
    console.log(JSON.stringify(getSongsFromLib))
    console.log(getSongsFromLib)
    console.log(e)
    res.send(JSON.stringify(getSongsFromLib))
  })
}
