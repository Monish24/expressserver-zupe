...
app.get('/api/getsongid', async (req, res) => {
  var artistsid = await (getprefartist('3e164cd7-df60-4e17-a90f-a7c87c06e7ae'))
  var artist1 = artistsid[0].favartist1
  var artist2 = artistsid[0].favartist2
  var artist3 = artistsid[0].favartist3

  var favgenre = await (getprefgenre('3e164cd7-df60-4e17-a90f-a7c87c06e7ae'))
  var gen1 = favgenre[0].favgenre1
  var gen2 = favgenre[0].favgenre2
  var gen3 = favgenre[0].favgenre3

  var pref = [artist1,artist2,artist3,gen1,gen2,gen3]
  console.log(pref)
  console.log(JSON.stringify(pref))
  res.send(JSON.stringify(pref))
})
