...
export function signupApi() {
  app.post('/auth/signup', (req, res) => {
    ...
    const song_language = body.song_language
    ...
    console.log(body)
    saveUser(new User(username, password, birthday, gender, user_email,song_language,fav_artist1, fav_artist2, fav_artist3,
