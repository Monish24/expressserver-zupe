...
export class User {
  ...
  constructor(username: string, password: string, birthday: Date, gender: string, user_email: string, song_language: string, fav_artist1: string, fav_artist2: string, fav_artist3: string,
